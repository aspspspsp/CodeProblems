package Easy;
/*
解法：这里有这样一个规律，从1到9，有9个只占1个位数的数字，
数字个数为10 - 1 + 1；从10到99，有90个占2个位数的数字，数
字个数为99 - 10 + 1，因此可以得到这样的规律：
范围	    占位	个数	        共占位
1——9	    1	    9-1+1 = 9       9*1=9
10——99	    2	    99-10+1=90	    90*2=180
100——999	3	    999-100+1=900	900*3=2700
……			
因此，如果要超照第n个单数字，首先要算出这个数字在哪个区间
范围，在该范围内每个实际的数字占几个位，这个范围内第一个
实际数字前已经占用了多少个单数字。然后，根据这些数据求出
具体的值。
*/
